...
from network.CrissCrossAttention import CrissCrossAttention
from network.vit import Mlp
...
class CEnet(nn.Module):
    def __init__(self, num_classes=43, num_channels=3):
        ...
        self.head = RCCAModule(512, 512, 512)
