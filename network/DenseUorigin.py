    ...
    def __init__(self, skip_connections, growth_rate=32, block_config=(6, 12, 24, 16), num_init_features=64, bn_size=4,
        ...
        for i in range(len(features)):
            ...
            if isinstance(module, _Transition):
                ...
                features[i] = (
                    name, _TransitionUp(module.conv.in_channels * m, module.conv.out_channels // 2, self.skip_connections))
...
if __name__=='__main__':
    # model = ghostnet()
    model = DenseUNet(n_classes=1, pretrained_encoder_uri='https://download.pytorch.org/models/densenet121-a639ec97.pth')
    # model = model.
