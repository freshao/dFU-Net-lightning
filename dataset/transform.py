...
data_grayscale = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize((0.3337), (0.2629))
])
data_enhance_list = [data_translate, data_hflip, data_transforms, data_vflip, data_shear, data_center,
                     data_jitter_brightness, data_jitter_contrast, data_jitter_hue,
                     data_jitter_saturation, data_rotate]
