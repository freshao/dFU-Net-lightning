...
# from pylab import *
# from dataset.load_nii import window_transform
...
def multi_dcm(path, save_path):
    ...
    for s in path_list:
        ...
        rows = dicom.Rows
        cols = dicom.Columns
        dcm_temp = window_transform(img_data)
...
train_path = '/opt/data/private/data/chao_data/Train_Sets/'
test_path = '/opt/data/private/data/chao_data/Test_Sets/'
valid_path = '/opt/data/private/data/chao_data/Valid_Sets/'
...
deal_chao(train_path, 'CT')
deal_chao(test_path, 'CT')
deal_chao(valid_path, 'CT')
