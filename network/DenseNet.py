...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int) -> None:
        ...
        self.add_module('conv', nn.Conv2d(num_input_features, num_output_features // 2,
                                          kernel_size=1, stride=1, bias=False))
        self.add_module('pool', nn.AvgPool2d(kernel_size=2, stride=2))
        # self.add_module('downsample', PatchMerging(num_output_features // 2))
        # self.add_module('respath'. ResidualPath(num_output_features, num_output_features))
